...
class PyRadmonBase:
    def __init__(self, config_yaml_path): 
        ...
        # Modern robust logging from the NEW version
        try:
        ...
        # OLD VERSION WAY: Directly load the YAML without creating temp files
        ...
        # Map directly to the original YAML file (Old Version behavior)
        ...
        os.environ['startdate'] = str(self.startdate)
        os.environ['enddate'] = str(self.enddate)
    ...
    # NEW VERSION WAY: move_files by ftgokas
    # --------------------------------------------------------
