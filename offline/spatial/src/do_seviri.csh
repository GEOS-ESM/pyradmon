...
foreach synop_hr ($hh)
  ...
  foreach sat (m08)
    ./ln_s ${archive}/${expver}.diag_seviri_${sat}_anl.${yyyymmdd}_${synop_hr}z.nc4
    ./pyradmon_spatial_driver_oma.py ${expver}.diag_seviri_${sat}_anl.${yyyymmdd}_${synop_hr}z.nc4

# All other plots (8 in all - including totbc, tbobs, omgbc, omgnbc; qc0 and qc1)

    ./ln_s ${archive}/${expver}.diag_seviri_${sat}_ges.${yyyymmdd}_${synop_hr}z.nc4
    ./pyradmon_spatial_driver_omf.py ${expver}.diag_seviri_${sat}_ges.${yyyymmdd}_${synop_hr}z.nc4
  end
end
foreach psensor (SEVIRI)
    foreach psatellite (METEOSAT-8)
