...
foreach synop_hr ($hh)
   ...
   foreach sat (gpm)
      ./ln_s ${archive}/${expver}.diag_gmi_${sat}_anl.${yyyymmdd}_${synop_hr}z.nc4
      ./pyradmon_spatial_driver_oma.py ${expver}.diag_gmi_${sat}_anl.${yyyymmdd}_${synop_hr}z.nc4

# All other plots (8 in all - including totbc, tbobs, omgbc, omgnbc; qc0 and qc1)
      ./ln_s ${archive}/${expver}.diag_gmi_${sat}_ges.${yyyymmdd}_${synop_hr}z.nc4
      ./pyradmon_spatial_driver_omf.py ${expver}.diag_gmi_${sat}_ges.${yyyymmdd}_${synop_hr}z.nc4
   end
end

foreach psensor (GMI)
    foreach psatellite ( GPM)
