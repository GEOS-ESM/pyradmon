...
# Pyradmon Spatial Basic Form - offline , run_all.csh
# --------------------------------------------------------------------------------------------------
...
class PyRadmonBase:
    ...
    # ----------------------
    def exec_run_all_driver(self):
        """
        execute run_all.csh
        """
        print(f'Now running: execute run_all.csh $expver $yyyymmdd $hh')

        try:
            subprocess.run(['./run_all.csh', self.expver, self.yyyymmdd, self.hh ]) 
        except Exception as e:
            error_message = f"Error: {e}"
            print(error_message)
            logging.error(error_message)
        print(f'finished: exec_run_all_driver   ------------------------------------------------------------------')
...
if __name__ == "__main__":
    ...
    PyRadmonConfig.exec_run_all_driver()